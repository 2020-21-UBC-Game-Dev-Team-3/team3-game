...
/*    if (PhotonNetwork.PlayerList.Length == 2) {
    ...
    if (PhotonNetwork.PlayerList.Length <= 6) {
      pv.RPC("FillInCrewmates", PhotonNetwork.PlayerList[randomIntList[0]], randomIntList[0]); // 1st imposter
      pv.RPC("FillInImposters", PhotonNetwork.PlayerList[randomIntList[1]], randomIntList[1]); // 1st disarmer
